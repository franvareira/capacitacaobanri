...
public class ReportFactory {
	...
	public static final String PATH_REPORT = System.getProperty("user.dir") + File.separator + "Report" +
			File.separator + "Report_" + DateTime.getDateTimeFormatScreenshot();
	...
	public static void configReportExtent() {
		...
		extentSparkReporter.config().setJs("$('.nav-logo').html('<img src=\"https://imgur.com/HkrrWKH.png\" class=\"banri-logo\"/>');");
